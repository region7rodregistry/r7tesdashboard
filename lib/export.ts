...
export function exportStatisticsCsv(
  ...
  const rows: unknown[][] = [];
  rows.push(["NTTC Registry — Statistics", "TESDA Region VII · Central Visayas"]);
...
export async function exportStatisticsPdf(
  ...
  doc.setFontSize(17);
  doc.text("NTTC Registry — Statistics", textX, cursorY + 16);

  doc.setFont("helvetica", "normal");
  doc.setFontSize(10);
  doc.setTextColor(90, 90, 90);
  doc.text("TESDA Region VII · Central Visayas", textX, cursorY + 32);
  doc.text(
